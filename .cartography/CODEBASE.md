...
- High-centrality modules (PageRank):
  ...
  - src/orchestrator.py (pagerank=0.037244, velocity_30d=11, dead=True)
  ...
  - src/agents/hydrologist.py (pagerank=0.037244, velocity_30d=8, dead=True)
  - src/agents/navigator.py (pagerank=0.037244, velocity_30d=3, dead=True)
  - src/agents/semanticist.py (pagerank=0.037244, velocity_30d=5, dead=True)
...
- src/models/__init__.py [__init__-package]: src/models/__init__.py is a Python module.
- src/llm/__init__.py [__init__-package]: src/llm/__init__.py is a Python module.
- src/graph/semantic_index.py [str-path]: src/graph/semantic_index.py defines classes: SemanticIndex, SemanticIndexEntry; functions: __init__, as_map, build, embed_texts, from_json, load, save, search.
...
- src/graph/__init__.py [__init__-package]: src/graph/__init__.py is a Python module.
- src/config.py [default-field]: src/config.py defines classes: CartographyConfig, IncrementalConfig, LLMConfig, NavigatorConfig, SemanticistConfig; functions: load_config.
...
- src/analyzers/__init__.py [__init__-package]: src/analyzers/__init__.py is a Python module.
...
- src/agents/__init__.py [__init__-package]: src/agents/__init__.py is a Python module.
- src/__init__.py [edge-source_file]: src/__init__.py is a Python module.
- main.py [edge-source_file]: main.py defines functions: main.
- cartography_config.yaml [default-field]: cartography_config.yaml is a YAML configuration file.
